...
const StoreNavBar = () => {
  ...
  return (
    <nav
      className={cn(
        "flex flex-col bg-white transition-all duration-700 fixed w-full z-10 shadow-sm",
        hideNavbar ? "top-[-180px]" : "top-0"
      )}
    >
      <section className="w-full h-20 py-3">
        <div className="storeContainer w-full h-full relative flex justify-between items-center">
          <Link href={"/"} className="mr-0 xl:mr-20 lg:mr-10 flex items-center">
            <Image alt="Shoppy Logo" src={"/shoppylogo.png"} width={120} height={40} quality={100} className="max-h-10 object-contain" />
          </Link>
      ...
      <section className="w-full border-b-gray-400 border-t-gray-300 border-b border-t">
