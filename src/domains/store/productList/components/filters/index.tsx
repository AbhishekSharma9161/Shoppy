...
const Filters = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "lg:min-w-[220px] w-[310px] ease-shoppy-easeOut transition-all pb-8 duration-500 lg:w-auto max-w-[260px] absolute lg:relative h-full px-5 border-r bg-white lg:z-1 z-20 border-gray-300 overflow-y-scroll",
      ...
      >
        ...
        <Button
          ...
          className="w-full py-1 text-sm rounded-md text-gray-100 border-none bg-shoppy-blue-500 hover:bg-shoppy-blue-600 active:bg-shoppy-blue-400 disabled:bg-shoppy-blue-700"
