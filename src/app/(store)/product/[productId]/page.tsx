...
const ProductPage = () => {
  ...
  return (
    <div className="storeContainer">
      <div className="w-full h-auto mt-44 flex flex-col">
            ...
            <div className="flex flex-col w-full h-auto">
              ...
              <div className="flex flex-col w-full">
                ...
                <div className="my-4 ml-12 text-sm leading-5 text-gary-900">
                  <span>
                    {`Experience cutting-edge technology with premium build quality and innovative features. 
                    This product combines performance, style, and reliability to deliver exceptional value. 
                    Designed with attention to detail and backed by industry-leading warranty and support.`}
                  </span>
                </div>
              </div>
            </div>
